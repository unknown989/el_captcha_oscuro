all:
	...
	clang++ main.cpp icon.res src/theoraplay.c src/GameState.cpp src/collision/*.cpp src/common/*.cpp src/dynamics/*.cpp src/rope/*.cpp -o a.exe -g -I include -L lib -w -lSDL2main -lSDL2 -lSDL2_image -lSDL2_mixer -lSDL2_ttf -logg -lvorbis -lvorbisfile -lvorbisenc -llibtheora_static -lmsvcrt
static:
	windres icon.rc -O coff -o icon.res
